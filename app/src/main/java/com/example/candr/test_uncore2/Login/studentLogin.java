...
public class studentLogin extends Activity {
    ...
    TextView admin,teacher,parent,staff;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        admin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(intent , ActivityOptions.makeSceneTransitionAnimation(studentLogin.this).toBundle());
            }
        });
        ...
        parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(studentLogin.this,parentLogin.class );
                startActivity(intent , ActivityOptions.makeSceneTransitionAnimation(studentLogin.this).toBundle());
            }
        });
        ...
        staff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(studentLogin.this,staffLogin.class );
                startActivity(intent , ActivityOptions.makeSceneTransitionAnimation(studentLogin.this).toBundle());
            }
        });
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Password.equals("")||ID.equals("")){
                    Toast.makeText(studentLogin.this, "Please Enter Your id/Password", Toast.LENGTH_SHORT).show();
                }else
                Toast.makeText(context,"incorect password/id",Toast.LENGTH_SHORT);
            }
        });
    }
}
